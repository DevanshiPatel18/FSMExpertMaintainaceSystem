...
class QuarComponent extends Component {
  state = {
    task1: "",
    task2: "",
    task3: "",
  ...
  render() {
    ...
    <Card style={{  }} body outline color="success" className="mx-auto my-2">
        ...
        <div >  
        <Row >
        <Col xs lg="3"><u><h5>Check Point</h5></u></Col>
        <Col xs lg="2"><u><h5>Standard</h5></u></Col>
        <Col ><u><h5>Jan-Mar</h5></u></Col>
        <Col ><u><h5>Apr-Jun</h5></u></Col>
        <Col ><u><h5>Jul-Sep</h5></u></Col>
        <Col ><u><h5>Oct-Dec</h5></u></Col>
                    </Row>
                  ...
                  <Row>   <Col xs lg="4"><h5 style={{ color: 'darkblue' }}>MACHINE 1</h5></Col>
                    ...
                    <Row >
                    <Col xs lg="3">1.1 CHECK GUIDE WAY TRACK FOR  WEAR</Col>
                ...
                <div >
                  ...
                  <Row>
                      <Col xs lg="3">1.2 BACKLASH </Col>
                      <Col xs lg="2">LESS THAN 0.005MM</Col>
                ...
                <div >
                    ...
                    <Row>
                      <Col xs lg="3">2.1 CHECK GUIDE WAY TRACK FOR  WEAR</Col>
                      <Col xs lg="2">NO WEAR</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="3">2.3 LUBRICATE  BY OIL GUN</Col>
                      <Col xs lg="2">5-6 STROKES </Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="3">3.1 CHECK BACK LASH IN BEARING</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="3">4.1 CHECK BACK LASH IN BEARING</Col>
                      <Col xs lg="2">LESS THAN 0.002 MM</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="3">5.1 CHECK BACK LASH IN DRIVE</Col>
                      <Col xs lg="2">LESS THAN 0.005 MM</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="3">6.1 CHECK AXIAL PLAY WITH  PULL LOAD  OF  200 N</Col>
                      <Col xs lg="2">LESS THAN  0.005 MM</Col>
