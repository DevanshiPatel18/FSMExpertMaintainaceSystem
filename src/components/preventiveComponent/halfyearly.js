...
class HalfComponent extends Component {
  state = {
    task1: "",
    task2: "",
    task3: "",
  ...
  render() {
    ...
    <Card style={{  }} body outline color="success" className="mx-auto my-2">
        ...
        <Col ><u><h5>Jan-Jun</h5></u></Col>
        <Col ><u><h5>Jul-Dec</h5></u></Col>
               ...
               <Row>   <Col xs lg="4"><h5 style={{ color: 'darkblue' }}>MACHINE 1</h5></Col>
                  ...
                  <div>
                    ...
                    <Row >
                    <Col xs lg="5">1.1 CLEAN FILTER  ELEMENT</Col>
                ...
                <div >
                  ...
                  <Row>
                      <Col xs lg="5">1.2 CHECK GAS CHARGING PRESSURE IN BLADDER </Col>
                      <Col xs lg="2">24-26 BAR</Col>
                ...
                <div >
                    ...
                    <Row>
                      <Col xs lg="5">1.3 INSPECT PIPES FOR NO LEAKAGE ( INDEXING AND CLAMPING SYSTEM )</Col>
                      <Col xs lg="2">NO LEAKAGE</Col>
                ...
                <div>
                    <Row>
                      <Col xs lg="5">1.4 CLEAN FILTER PAD AND OIL DRAIN PASSAGE </Col>
                      <Col xs lg="2">CLEAN</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">2.1 CHECK LOCKING NUT TIGHTENESS</Col>
                      <Col xs lg="2">TIGHT</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">2.2 CHECK SHAFT AND BUSH FOR PLAY</Col>
                      <Col xs lg="2">NO PLAY</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">2.3 CHECK SEALING GASKET CONDITION</Col>
                      <Col xs lg="2">NO CRACKS</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">2.4 CHECK RUBBER DAMPER ON HINGES</Col>
                      <Col xs lg="2">NO CRACKS</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">2.5 CHECK SHAFT AND BUSH FOR PLAY</Col>
                      <Col xs lg="2">NO PLAY</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.1 CHECK DAMPER RUBBER CONDITION</Col>
                      <Col xs lg="2">NO CRACKS</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.2 CHECK DAMPER RUBBER CONDITION</Col>
                      <Col xs lg="2">NO CRACKS</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.3 CHECK RUN-OUT</Col>
                      <Col xs lg="2">LESS THAN  0.005 MM</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.4 CHECKING THE COMPRESSED AIR </Col>
                      <Col xs lg="2">WEAK POSITIVE AIR FLOW </Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.5 CHECK V-RING CONDITION FOR WEAR</Col>
                ...
                <div>
                    ...
                    <Row>
                      <Col xs lg="5">3.6 CHECK RUN-OUT</Col>
                      <Col xs lg="2">LESS THAN 0.005 MM</Col>
