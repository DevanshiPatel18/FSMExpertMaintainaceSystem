...
class Jan extends Component {
 ...
 <center><Home style={{ color: blue[800] , fontSize: 40}}/> </center>
  ...
  <ExitToAppIcon onClick={event => { window.location.href='/'
     ...
     <center><h2>Jishu-Hozen Checklist for May</h2></center> 
