...
class Month0ProgressComponent extends Component {
  state = {
    task1: "",
    task2: "",
    task3: "",
...
<br></br >
    <Card style={{ width: '112rem' }} body outline color="success" className="mx-auto my-2">
        ...
        <Col ><u><h5> 28</h5></u></Col>
                    ...
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                ...
                <div >
                  ...
                  <Row>
                    ...
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>                    </Row>
                </div>
                ...
                <div>
                    ...
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col><Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>
                    <Col><ProgressBar label={task1.status} variant="success" style={{width: "10px"}} now={task1} /></Col>                    </Row>
...
export default Month0ProgressComponent;
